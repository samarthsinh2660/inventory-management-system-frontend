...
import { AuditLogFiltersState, AuditLogFiltersModalProps } from '@/types/general';
import { AuditAction } from '@/types/log';
import { ProductCategory } from '@/types/product';
import { useAppDispatch } from '@/hooks/useAppDispatch';

export const AuditLogFiltersModal: React.FC<AuditLogFiltersModalProps> = ({
  isVisible,
  onClose,
  filters,
  onApplyFilters,
  ...
  const [localFilters, setLocalFilters] = useState<AuditLogFiltersState>(filters);
  ...
  // Filter products based on selected filters (similar to inventory filters)
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.pickerContainer}>
              ...
              <Picker
                selectedValue={localFilters.action}
                onValueChange={(value) => setLocalFilters({ ...localFilters, action: value })}
                style={styles.picker}
              >
                <Picker.Item label="All Actions" value="" />
                <Picker.Item label="Create" value={AuditAction.CREATE} />
                <Picker.Item label="Update" value={AuditAction.UPDATE} />
                <Picker.Item label="Delete" value={AuditAction.DELETE} />
              </Picker>
            </View>
          </View>
            ...
            <View style={styles.pickerContainer}>
              ...
              <Picker
                ...
                onValueChange={(value) => setLocalFilters({ 
                  ...
                  product_id: 0 // Reset product when subcategory changes
                })}
                style={styles.picker}
              >
          ...
          <View style={styles.section}>
            ...
            <TextInput
              ...
              mode="outlined"
              placeholder="Enter specific reference ID"
            />
          </View>
                ...
                <TextInput
                  ...
                  right={<TextInput.Icon icon="calendar" onPress={() => {
                    if (!localFilters.date_from) {
                      setLocalFilters({ ...localFilters, date_from: getDateNDaysAgo(7), days: 0 });
                    }
                  }} />}
                />
              </View>
